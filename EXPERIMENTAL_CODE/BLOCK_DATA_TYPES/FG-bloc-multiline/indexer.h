...
public:
	...
	void constructSubMatrices(SparseMatrix<Element>& M,
			SparseBlocMatrix<SparseMultilineBloc<uint16, Index> >& A, SparseBlocMatrix<SparseMultilineBloc<uint16, Index> >& B,
			SparseBlocMatrix<SparseMultilineBloc<uint16, Index> >& C, SparseBlocMatrix<SparseMultilineBloc<uint16, Index> >& D,
