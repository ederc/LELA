...
public:
	...
	template <typename Element, typename Index>
	static void copy(const SparseBlocMatrix<SparseMultilineBloc<Element, Index> >& A, SparseMatrix<Element>& B);
	...
	template <typename Element, typename Index>
	static void dumpMatrixAsPbmImage(const SparseBlocMatrix<SparseMultilineBloc<Element, Index> >& A, const char *outputFileName);
	...
	template <typename Element, typename Index>
	static bool equal(const Modular<Element>& R, const SparseBlocMatrix<SparseMultilineBloc<Element, Index> >& A, const SparseMatrix<Element>& B);

	template <typename Element, typename Index>
	static bool equal(const Modular<Element>& R, const SparseMatrix<Element>& A, const SparseBlocMatrix<SparseMultilineBloc<Element, Index> >& B);
