...
template <typename Element, typename Index>
void MatrixUtils::copy(const SparseBlocMatrix<SparseMultilineBloc<Element, Index> >& A, SparseMatrix<Element>& B)
{
...
template <typename Element, typename Index>
void MatrixUtils::bloc_to_sparse_copyDownTopLeftRight(const SparseBlocMatrix<SparseMultilineBloc<Element, Index> >& A, SparseMatrix<Element>& B)
{
	//typename SparseBlocMatrix<SparseMultilineBloc<Element, Index> >::Row::const_iterator it_bloc;
	//typename SparseBlocMatrix<SparseMultilineBloc<Element, Index> >::BlocType::Row::const_iterator it;
...
template <typename Element, typename Index>
void MatrixUtils::dumpMatrixAsPbmImage(const SparseBlocMatrix<SparseMultilineBloc<Element, Index> >& A, const char *outputFileName)
{
...
template <typename Element, typename Index>
bool MatrixUtils::equal(const Modular<Element>& R, const SparseBlocMatrix<SparseMultilineBloc<Element, Index> >& A, const SparseMatrix<Element>& B)
{
	SparseMatrix<Element> tmp (A.rowdim(), A.coldim());
	copy(A, tmp);
...
template <typename Element, typename Index>
bool MatrixUtils::equal(const Modular<Element>& R, const SparseMatrix<Element>& A, const SparseBlocMatrix<SparseMultilineBloc<Element, Index> >& B)
{
	return equal(R, B, A);
}
