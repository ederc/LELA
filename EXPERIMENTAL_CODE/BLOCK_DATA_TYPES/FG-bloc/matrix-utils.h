...
public:
	...
	static void copy(const SparseMatrix<Element>& A, SparseBlocMatrix<Element, Index>& B);

	template <typename Element, typename Index>
	static void copy(const SparseBlocMatrix<Element, Index>& A, SparseMatrix<Element>& B);
	...
	template <typename Element, typename Index>
	static void dumpMatrixAsPbmImage(const SparseBlocMatrix<Element, Index>& A, const char *outputFileName);
	...
	template <typename Element, typename Index>
	static bool equal(const Modular<Element>& R, const SparseBlocMatrix<Element, Index>& A, const SparseMatrix<Element>& B);

	template <typename Element, typename Index>
	static bool equal(const Modular<Element>& R, const SparseMatrix<Element>& A, const SparseBlocMatrix<Element, Index>& B);
...
private:
	/*template <typename Element, typename Index>
	static void sparse_to_bloc_copyDownTopRightLeft(const SparseMatrix<Element>& A, SparseBlocMatrix<Element, Index>& B);*/
	...
	template <typename Element, typename Index>
	static void sparse_to_bloc_copyTopDowLeftRight(const SparseMatrix<Element>& A, SparseBlocMatrix<Element, Index>& B);

	template <typename Element, typename Index>
	static void sparse_to_bloc_copyDownTopLeftRight(const SparseMatrix<Element>& A, SparseBlocMatrix<Element, Index>& B);



	template <typename Element, typename Index>
	static void bloc_to_sparse_copyDownTopRightLeft(const SparseBlocMatrix<Element, Index>& A, SparseMatrix<Element>& B);

	template <typename Element, typename Index>
	static void bloc_to_sparse_copyTopDowLeftRight(const SparseBlocMatrix<Element, Index>& A, SparseMatrix<Element>& B);

	template <typename Element, typename Index>
	static void bloc_to_sparse_copyDownTopLeftRight(const SparseBlocMatrix<Element, Index>& A, SparseMatrix<Element>& B);
