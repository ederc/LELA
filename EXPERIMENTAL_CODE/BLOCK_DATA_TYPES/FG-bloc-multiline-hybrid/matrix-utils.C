...
template <typename Element, typename Index>
void MatrixUtils::copy(SparseBlocMatrix<SparseMultilineBloc<Element, Index> >& A, SparseMatrix<Element>& B)
{
...
template <typename Element>
std::pair<uint64, double> MatrixUtils::getMatrixSizeAndDensity(const SparseMatrix<Element>& A)
{
	uint64 nb_elts = 0;
